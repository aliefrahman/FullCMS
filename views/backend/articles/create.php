...
<div class="space-y-6 max-w-5xl mx-auto">
    ...
    <form id="article-form" method="POST" action="<?php echo PUBLIC_URL; ?>/admin/articles/store"
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white border border-slate-100 rounded-3xl shadow-sm p-6 md:p-8 space-y-6">
                <div>
                    ...
                    <p class="text-xs text-slate-500 font-medium">Tuliskan ide dan pemikiran brilian Anda di sini.</p>
                </div>
            ...
            <div class="bg-white border border-slate-100 rounded-3xl shadow-sm p-6 md:p-8 space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <?php else: ?>
                            <div class="w-full border border-slate-200 bg-slate-50 rounded-xl px-4 py-3 text-sm font-bold text-amber-600 flex items-center justify-between cursor-not-allowed"
                                title="Anda tidak memiliki izin mempublikasikan artikel secara langsung.">
                                <span>Draf (Belum Tayang)</span>
                                <i data-lucide="lock" class="w-4 h-4 text-amber-400"></i>
                            </div>
                            <input type="hidden" name="status" value="draft">
                            <p class="text-[10px] text-slate-400 font-semibold leading-tight mt-1">Artikel Anda akan
                                menunggu ulasan Editor untuk dipublikasikan.</p>
                        <?php endif; ?>
                    </div>
                            ...
                            <div class="text-center" x-show="!fileName">
                                <div
                                    ...
                                    <i data-lucide="image-plus"
                                        class="h-5 w-5 text-slate-400 group-hover:text-primary-500"></i>
                                </div>
