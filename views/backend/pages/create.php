...
<div class="space-y-6 max-w-5xl mx-auto">
    ...
    <form id="page-form" method="POST" action="<?php echo PUBLIC_URL; ?>/admin/pages/store" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white border border-slate-100 rounded-3xl shadow-sm p-6 md:p-8 space-y-6">
                <div>
                    <h3 class="font-display font-extrabold text-lg text-slate-800">Konten Halaman</h3>
                    <p class="text-xs text-slate-400 font-medium mt-0.5">Tulis judul dan lengkapi isi halaman statis Anda di sini</p>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="title" placeholder="Masukkan judul halaman (misal: Hubungi Kami)..." class="w-full border border-slate-200 rounded-xl px-4 py-3 text-lg font-bold text-slate-800 placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all duration-200" required />
                    </div>
                    ...
                    <div class="space-y-1.5">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-[10px] text-slate-400 uppercase font-semibold">Otomatis Terisi</span>
                        </div>
                        <div class="flex items-center border border-slate-200 rounded-xl px-3 py-2 bg-slate-50 text-sm focus-within:bg-white focus-within:ring-2 focus-within:ring-primary-500/20 focus-within:border-primary-500 transition-all duration-200">
                            ...
                            <input type="text" name="slug" placeholder="judul-halaman-anda" class="w-full bg-transparent border-none text-slate-700 placeholder-slate-400 focus:outline-none ml-1" />
                        </div>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea name="content" id="page-content" class="hidden" required></textarea>
                        
                        <!-- Quill Editor Container -->
                        <div class="border border-slate-200 rounded-xl overflow-hidden shadow-sm bg-white">
                            <div id="editor" class="h-96 text-slate-850 text-sm"></div>
                        </div>
            ...
            <div class="bg-white border border-slate-100 rounded-3xl shadow-sm p-6 md:p-8 space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea name="meta_description" rows="5" placeholder="Tulis deskripsi singkat halaman untuk penelusuran mesin pencari Google (SEO)..." class="w-full border border-slate-200 rounded-xl px-4 py-3 text-xs text-slate-800 placeholder-slate-350 focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all duration-200"></textarea>
